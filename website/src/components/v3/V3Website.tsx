...
export function V3ProductPage() {
  const productRows: ProductCard[] = [
    ...
    { icon: GraduationCap, status: "Private beta", statusTone: "soon", title: "Learn", meta: "A tutor that remembers.", body: "A full study product: AI-built books, exam practice, knowledge bases, and tutors that live in WhatsApp and Telegram. In private beta — we ship it when it's truly ready.", wide: true },
