...
const LEGAL_POLICY_VERSION = process.env.ZAKI_LEGAL_POLICY_VERSION || "2026-07-12.v4";
...
function ensureHireEngineContainer() {
  ...
  if (!containerExists(HIRE_ENGINE_CONTAINER)) {
    ...
    docker([
      ...
      "-e", "ZAKI_METER_GRANT_SIGNING_SECRET=local-hire-meter-signing-key-2026-dev-only",
      "-e", "ZAKI_HIRE_METER_SIGNING_KEY=local-hire-meter-signing-key-2026-dev-only",
...
function backendEnv() {
  const env = {
    ...
    ZAKI_METER_GRANT_SIGNING_SECRET: "local-hire-meter-signing-key-2026-dev-only",
    ZAKI_HIRE_METER_SIGNING_KEY: "local-hire-meter-signing-key-2026-dev-only",
