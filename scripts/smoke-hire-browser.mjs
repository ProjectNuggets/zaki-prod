 ...
 * pipeline/detail view, captures a screenshot, then deletes the temporary lead.
 */
...
async function main() {
  ...
  try {
    ...
    await page.getByText("ZAKI Browser Smoke Labs · Remote").waitFor({ state: "visible", timeout: 10_000 });
