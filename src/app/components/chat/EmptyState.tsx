...
import { EmptyState as ZakiEmptyState } from "@/app/components/ui/zaki";
...
export function EmptyState({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center h-full px-6", className)}>
      <ZakiEmptyState
        icon={<CenterLogo className="size-5 text-zaki-brand" />}
        title={t("empty.greeting", { name: userName })}
        helper={t("empty.subtext")}
        action={
          <div className="flex flex-col items-center gap-3">
            <div className="zaki-meta">
              {t("empty.ctaHelper")}
            </div>
      ...
      <div className="w-full max-w-lg space-y-2 mt-6">
