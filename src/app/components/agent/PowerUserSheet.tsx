...
export function PowerUserSheet({
  ...
  const renderControls = () => {
    ...
    const cpPct = typeof contextPressurePercent === "number" ? contextPressurePercent : null;
    const contextTone =
      cpPct != null && cpPct >= CONTEXT_PRESSURE_NEAR_LIMIT
        ? "text-rose-600 dark:text-rose-400"
        : cpPct != null && cpPct >= CONTEXT_PRESSURE_WARNING
