...
export function TypeToConfirmDialog({
  ...
  return (
    <ModalShell
      ...
      onClose={onCancel}
      role="alertdialog"
      ariaLabelledBy="ttc-confirm-title"
    ...
    >
      <div className="flex items-start justify-between gap-3 p-5 border-b border-zaki dark:border-[rgba(240,236,230,0.06)]">
        <div className="flex items-start gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <h2 id="ttc-confirm-title" className="font-display font-bold text-zaki-primary text-lg tracking-[-0.02em]">
              {title}
            </h2>
      ...
      <div className="p-5">
        <label htmlFor="ttc-confirm-input" className="block text-xs font-medium text-zaki-secondary mb-2">
          Type <span className="font-mono-ui text-zaki-brand">{confirmPhrase}</span> to confirm
        </label>
        <input
          id="ttc-confirm-input"
          type="text"
          value={value}
      ...
      <div className="flex items-center justify-end gap-2 p-5 pt-0">
        ...
        <button
          ...
          className={cn(
            ...
            canConfirm
              ? "bg-zaki-brand text-white shadow-[0_8px_24px_rgba(210,68,48,0.25)] hover:-translate-y-0.5"
