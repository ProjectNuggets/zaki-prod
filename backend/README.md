...
- `STRIPE_PRICE_PERSONAL_YEARLY` (optional Personal yearly Stripe price)
- `STRIPE_PRICE_PRO` (Pro monthly Stripe price)
- `STRIPE_PRICE_PRO_YEARLY` (optional Pro yearly Stripe price)
- `STRIPE_PRICE_PRO_MAX` (Pro Max monthly Stripe price)
- `STRIPE_PRICE_PRO_MAX_YEARLY` (optional Pro Max yearly Stripe price)
